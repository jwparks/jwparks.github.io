...
만약 `1920×1080` 해상도의 이미지 한 장을 렌더링 한다고 가정하면 총 2,073,600개의 광선을 정의하고 추적해야 합니다.
...
그냥 아래 절반 흰색으로 칠한거 아니냐구요? 놀랍게도 아닙니다... :sweat_smile:

지금 보고 계신 `1920×1080` 해상도의 이미지 한 장을 렌더링하기 위해 카메라로부터 뻗어나가는 2,073,600개의 광선을 정의하고, 
