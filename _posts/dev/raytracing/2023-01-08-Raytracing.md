...
<a href="https://ibb.co/jzTFL4t"><img src="https://i.ibb.co/JqKPzkZ/1.png" alt="1" border="0"></a>
...
카메라의 위치 $\vec{C_0}(x,y,z)$와 방향 $\vec{C_d}(x,y,z)$, 카메라의 시야각(FOV)이 정해지면 각 픽셀을 통과하는 광선들의 공간 벡터의 방향을 계산 할 수 있습니다. 
